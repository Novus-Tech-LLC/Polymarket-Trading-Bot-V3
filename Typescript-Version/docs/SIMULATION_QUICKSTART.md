...
### Example 3: Compare Multiple Traders
...
│   └── ...
├── src/cli/commands/
│   ├── simulate-profitability.ts    # Main simulation script
│   ├── run-simulations.ts           # Batch simulation runner
│   └── compare-results.ts           # Comparison tool
└── docs/
...
- Verify trader address is correct
...
1. Increase starting capital in `simulate-profitability.ts`
2. Use smaller multiplier (0.5x)
3. Select different trader with larger positions
